...
export default function ListFilm(props) {
  ...
  return (
    ...
    className="py-20"
      ...
      items={[
        {
          label: <h1 className=" sm:text-sm md:text-xl lg:text-2xl font-semibold text-cyan-400" >PHIM ĐANG CHIẾU</h1>,
          key: "1",
          children: <NowShowing arrPhimDangChieu={arrPhimDangChieu} />,
        },
        {
          label: <h1 className=" font-semibold sm:text-sm md:text-xl lg:text-2xl text-cyan-400">PHIM SẮP CHIẾU</h1>,
          key: "2",
